...
public class Calculator {
  ...
  /**
   * Method add. Складываем первое и второе число.
   *
  ...
  /**
   * Method subtract. Вычитаем из первого числа второе
   *
   * @param first First numeral.
   * @param second Second numeral.
  ...
  /**
   * Method div. делим первое число на второе
   *
   * @param first First numeral.
   * @param second Second numeral.
  ...
  /**
   * Method multiple. Умножаем первое число на второе
   *
   * @param first First numeral.
   * @param second Second numeral.
